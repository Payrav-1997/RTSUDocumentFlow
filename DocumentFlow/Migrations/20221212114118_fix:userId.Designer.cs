...
namespace DocumentFlow.Migrations
{
    ...
    [Migration("20221212114118_fix:userId")]
            ...
            modelBuilder.Entity("DocumentFlow.Models.Department", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            CreatedAt = new DateTime(2022, 12, 12, 11, 41, 18, 225, DateTimeKind.Utc).AddTicks(2749),
                            Name = "Test"
                        });
                });
            ...
            modelBuilder.Entity("DocumentFlow.Models.User", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = new Guid("b5155727-86b9-4937-a351-77a1ed0d9b55"),
                            Address = "Test",
                            CreatedAt = new DateTime(2022, 12, 12, 11, 41, 18, 308, DateTimeKind.Utc).AddTicks(5333),
                            ...
                            Name = "Админ",
                            Password = "$2b$10$b.QMPeefK8RR4oLYG5TT0e8yU23rrZTQTsOb8xlcxeCVjf66nrpWi",
                            Phone = "+992915224442",
                            RoleId = 1
                        });
                });
