...
namespace DocumentFlow.Migrations
{
    ...
    [Migration("20221212151327_fix: notion")]
    partial class fixnotion
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("DocumentFlow.Models.Department", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            CreatedAt = new DateTime(2022, 12, 12, 15, 13, 27, 687, DateTimeKind.Utc).AddTicks(3166),
                            Name = "Test"
                        });
                });
            ...
            modelBuilder.Entity("DocumentFlow.Models.User", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = new Guid("bd83f250-71b0-4557-a994-844666b40b89"),
                            Address = "Test",
                            CreatedAt = new DateTime(2022, 12, 12, 15, 13, 27, 769, DateTimeKind.Utc).AddTicks(6105),
                            ...
                            Name = "Админ",
                            Password = "$2b$10$mVMvjfpQDZ73waxXcbJeweRpMKdIqnCODnhefpIPZPngjttdZxzhG",
                            Phone = "+992915224442",
                            RoleId = 1
                        });
                });
